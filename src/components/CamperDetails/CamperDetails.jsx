...
const CamperDetails = ({ camper = null, camperId = null, variant = null }) => {
  ...
  return (
    <div className="flex items-center gap-6 px-6 py-4 border border-gray-300 rounded-xl h-full w-full">
      <div
        className="overflow-hidden w-[290px] h-[320px] shrink-0 rounded-xl
      flex flex-col gap-2
      "
      >
