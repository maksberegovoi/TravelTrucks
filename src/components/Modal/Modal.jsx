  ...
  return (
    <>
      ...
      >
        <button
          onClick={onClose}
          className="cursor-pointer active:scale-90 absolute top-4 right-4 p-2 rounded-lg hover:bg-gray-100 transition-colors z-10"
          aria-label="Close"
        >
          <svg
        ...
        <div className="h-full overflow-y-auto">
          <div className="min-h-full py-20 px-10 ">{children}</div>
        </div>
      </div>
    </>
  );
