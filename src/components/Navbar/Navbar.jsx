...
const Navbar = () => {
  ...
  return (
    <header className="myContainer flex items-center justify-between sticky top-0 w-full bg-[var(--color-background)] px-16 z-100 border-b border-gray-300">
      ...
      <Modal isOpen={isOpen} toggle={toggleMenu}>
        <nav className="hidden md:flex gap-10 grow justify-center items-center bg-[var(--color-background)] ">
          {navLinks.map(({ name, path }) => (
            <NavLink key={path} to={path} className="interactive">
              {name}
            </NavLink>
